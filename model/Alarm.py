...
class Alarm:
    ...
    def __init__(self, id, date, correction_date, correction_status,
                 ...
                 ies_city, ies_state, ies_address, ies_group, ies_sede, course_name, course_area,
                 course_workload,
                 ):
    ...
    def from_alarm(self):
        values = {
            ...
            DBUtil.ALARM_DATE: self._date,
            DBUtil.ALARM_CORRECTION_DATE: self._correction_date,
